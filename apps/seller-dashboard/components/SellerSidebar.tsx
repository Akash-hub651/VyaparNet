    ...
    items: [
      {
        ...
        disabled: true,
        disabledReason: "Returns jald aayega — Sprint 9",
      },
      {
        id: "nav-disputes",
        href: "/disputes",
        ...
        icon: icons.Shield,
        disabled: true,
        disabledReason: "Disputes jald aayega — Sprint 9",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: icons.Wallet,
        disabled: true,
        disabledReason: "Payouts jald aayega — Sprint 9",
      },
    ],
  },
  {
