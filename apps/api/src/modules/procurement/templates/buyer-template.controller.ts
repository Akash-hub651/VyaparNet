...
import { CreateProcurementTemplateDto, CreateProcurementTemplateSchema, UpdateProcurementTemplateDto, UpdateProcurementTemplateSchema } from '@vyaparnet/types';
...
export class BuyerProcurementTemplateController {
  ...
  async createTemplate(
    @Req() req: any,
    @Body(new ZodValidationPipe(CreateProcurementTemplateSchema)) dto: CreateProcurementTemplateDto
  ...
  @Get(':id')
  async getTemplate(@Req() req: any, @Param('id') id: string): Promise<ProcurementTemplate> {
  ...
  async updateTemplate(
    @Req() req: any,
    @Param('id') id: string,
    @Body(new ZodValidationPipe(UpdateProcurementTemplateSchema)) dto: UpdateProcurementTemplateDto
  ): Promise<ProcurementTemplate> {
    return this.templateService.updateTemplate(id, req.user.id, dto);
  }

  @Delete(':id')
  async deleteTemplate(@Req() req: any, @Param('id') id: string): Promise<ProcurementTemplate> {
